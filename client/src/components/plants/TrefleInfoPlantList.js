...
export default class TrefleInfoPlantList extends Component {
  ...
  render() {
    ...
    const hasDistributionArray =
      this.props.trefleInfoPlant.main_species.distribution &&
    ...
    //chooses 3 random distribution native countries from the array
          ...
          <table className="table table-responsive d-table table-borderless">
            <tbody>
              ...
              <tr scope="row">
                ...
                {!this.props.trefleInfoPlant.scientific_name ? (
                  <td>currently unavailable</td>
                ) : (
                  <td style={{ textTransform: "capitalize" }}>
                    {this.props.trefleInfoPlant.scientific_name}
              ...
              <tr scope="row" className="tr-color">
                ...
                {!this.props.trefleInfoPlant.family_common_name ? (
                  <td>currently unavailable</td>
                ) : (
                  <td style={{ textTransform: "capitalize" }}>
                    {" "}
